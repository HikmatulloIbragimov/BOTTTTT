    ...
    try:
        if is_start:
            ...
            system_prompt = (
                ...
                "ОТВЕЧАЙ ВСЕГДА НА ТОМ ЯЗЫКЕ, НА КОТОРОМ ТЕБЕ НАПИСАЛИ. "  # Ключевая фраза
                "Если пишут на английском — отвечай на английском, если на русском — на русском. "
                "Общайся живо, используй подходящий сленг для выбранного языка. "
            )
